      ...
      <div class="row">
        <div class="col-md-12">
          ...
          if ($result->num_rows > 0) {
            ...
            ?>
                        <div class="simpleLens-big-image-container"><a data-lens-image="admin/<?php echo $row['image'] ?>" class="simpleLens-lens-image"><img src="admin/<?php echo $row['image'] ?>" width="250" height="300" class="simpleLens-big-image"></a></div>
                      </div>
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    ...
                    <div class="aa-prod-quantity">
                      ...
                      <?php
                      $sql = "SELECT categories.catname, categories.category_id, products.category_id FROM products, categories WHERE categories.category_id = products.category_id AND product_id = $_GET[product_id]";
                      $result = $conn->query($sql);
                      while($row = $result->fetch_assoc()) {
                        ?>
                      <p class="aa-prod-category">
                        Category: <a href="#"><?php echo $row['catname'] ?></a>
                      </p>
                        <?php
                      }
